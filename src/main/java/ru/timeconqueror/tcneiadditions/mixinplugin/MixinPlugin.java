...
import static ru.timeconqueror.tcneiadditions.mixinplugin.TargetedMod.VANILLA;
...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    private static final Logger LOG = LogManager.getLogger("tcneiadditions mixins");
